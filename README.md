...
**У каждого пользователя есть одно бесплатное демо-применение** на один компьютер: можно один раз проверить эффект на своём железе без ключа. Повторно бесплатное демо на том же ПК не выдаётся — дальше нужен платный ключ.
